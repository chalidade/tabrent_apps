...
export default function ListUser() {
 ...
 const handleDetailUser = ({data}) => {
   setPhoto(JSON.parse(data.order_picture_rent)[0]);
   setModal(data);
   setShow(true);
 }
              ...
              <div className="">
                <div style={{width: '100%', overflowX: 'scroll'}}>
                    <table className="mt-3 mb-3" style={{width: '100%'}}>
                        ...
                        <td>
                          <label>
                            <img alt="" src={photo ?  MAIN+photo : ""} style={{width: '100%', border: 'none', padding: '0px'}} />
                          </label>
                        </td>
                        </tr>
                    </table>
                ...
                <p className="m-1"><font style={{fontSize: '14px'}}><b>Transfer Total :</b></font> <br /> <font style={{fontSize: '12px'}}>Rp {modal.order_total_rent ? modal.order_total_rent.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : "-"}</font></p>
             </div>
            </Modal.Body>
            <Modal.Footer>

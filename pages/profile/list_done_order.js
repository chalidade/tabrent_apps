        ...
        <table width="100%" className="mt-4">
          <tr>
            <td className="text-left">
              <p className="mb-0 weight-700">Order Done</p>
            </td>
              ...
              <Modal.Header closeButton>
                ...
                <Modal.Body>
                  ...
                  <div className="mt-3">
                    ...
                    <p className="m-1"><font style={{fontSize: '12px'}}>Total Payment :</font> <br /> <b>{data.product_price.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</b></p>
                  </div>
                </Modal.Body>
                <Modal.Footer>
